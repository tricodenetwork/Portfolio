...
export default function Professional() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-5 mx-[2rem] justify-center items-start gap-3">
        ...
        <div className="w-[90%] flex-col justify-start items-center gap-[15px] inline-flex">
          <div className="w-full h-px bg-gray-600" />
