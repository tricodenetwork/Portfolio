      ...
      >
        <div className="self-stretch flex-col justify-start items-center gap-[100px] inline-flex">
          ...
          <div className="flex-col justify-center items-center gap-[50px] flex">
            <div className="w-full h-auto mx-3 py-8 pr-8 bg-white rounded-[10px] shadow justify-center items-center gap-4 flex">
              <div className="w-3 h-full bg-amber-400">s</div>
            ...
            <div className="w-full h-auto p-8 bg-white rounded-[10px] shadow justify-center items-start gap-4 flex">
              <div className="w-[5px] h-[500px] bg-amber-400"></div>
              <div className="flex-col flex pl-6 gap-4">
            ...
            {works.map(({ id, title, subtitle }) => {
              return (
                <div key={id} className="w-full h-auto py-8 pr-8 bg-white rounded-[10px] shadow justify-center items-start gap-4 flex">
                  <div className="w-3 h-full bg-amber-400">s</div>
                  <div className="flex-col flex pl-6 gap-4">
                    <div className="self-stretch text-slate-800  text-xl md:text-[28px] font-semibold font-['Work Sans'] leading-7">
                      {title}
